(function() {
    ...
    // 1. СТИЛИ (Полная изоляция и блокировка)
    ...
    if (!document.getElementById(styleId)) {
        ...
        style.innerHTML = `
            ...
            .dm-consent-box {
                ...
                border-radius: 12px !important; max-width: 550px !important; width: 100% !important;
            ...
            .dm-btn {
                ...
                padding: 14px 30px !important; border-radius: 6px !important; cursor: pointer !important;
            ...
            .dm-universal-footer {
                ...
                border-top: 1px solid #30363d !important; display: block !important;
            }
    ...
    function mount() {
        ...
        modal.innerHTML = `
            <div class="dm-consent-box">
                <h2 style="color:#58a6ff !important; margin:0 0 10px 0 !important; font-size:24px !important; display:block !important; font-weight:bold !important;">Rechtliche Bestätigung</h2>
                ...
                <div style="text-align:left !important; background:#0d1117 !important; padding:18px !important; border-radius:8px !important; border-left:4px solid #58a6ff !important; font-size:12.5px !important; line-height:1.6 !important; color:#c9d1d9 !important; margin-bottom:20px !important;">
    ...
    function addFooter() {
        ...
        footer.innerHTML = `
            ...
            <a href="https://dmamax.netlify.app/impressum" style="z-index:999999;" target="_blank">Impressum</a> | 
            <a href="https://dmamax.netlify.app/datenschutz" target="_blank">Datenschutz</a>
        `;
        document.documentElement.appendChild(footer);
    }

    // Интервал для принудительного удержания (каждую секунду)
    setInterval(() => {
        if (!isAccepted) {
            mount();
        } else {
